...
const CrearVitamina = () => {
  ...
  const [hora_ingesta, setHora_ingesta] = useState('');
  ...
  const handleGuardar = async () => {
    ...
    await axios.post('http://127.0.0.1:8000/api/medicamentosvitaminas/crear/', data, config)
      .then(response => {
  ...
  return (
    <View style={styles.container} >
      <Text style={styles.title} >Ingesta Vitamina o medicamento</Text>
